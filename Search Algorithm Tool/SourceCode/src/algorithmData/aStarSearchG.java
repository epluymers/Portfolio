 ...
 * Description: Implements A Star Search Algorithm for Graph Data
 */
public class aStarSearchG implements algorithmInterface
{
	/*
	 ...
	 */
	public aStarSearchG(abstractData data)
	{
	...
	public int nextIteration() throws algorithmException
	{
		...
		ArrayList<Integer> lowHeurCostFront = myData.getLowHeurCostFrontier();
		myData.addSolution(lowHeurCostFront);
		return 0;
	}
