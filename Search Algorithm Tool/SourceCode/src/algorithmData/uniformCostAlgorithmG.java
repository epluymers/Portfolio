//==============================================================================
/**
 * File Name:   uniformCostAlgorithmG.java
 *
...
/*
 * Class: uniformCostAlgorithmG
 * Package: algorithmData
 * Implements: algorithmInterface
 * Description: Implements Uniform Cost Algorithm for Graph Data
 */
public class uniformCostAlgorithmG implements algorithmInterface
{
	/*
	 ...
	 */
	public uniformCostAlgorithmG(abstractData data)
	{
	...
	public int nextIteration() throws algorithmException
	{
		...
		ArrayList<Integer> cheepestFront = myData.getCheapestFrontier();
		myData.addSolution(cheepestFront);
		return 0;
	}
