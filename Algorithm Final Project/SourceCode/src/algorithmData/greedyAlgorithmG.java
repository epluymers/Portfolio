...
/*
 * Class: greedyAlgorithmG
 * Package: algorithmData
 * Implements: algorithmInterface
 * Description: Implements Greedy Algorithm for Graph Data
 */
public class greedyAlgorithmG implements algorithmInterface
{
	/*
	 ...
	 */
	public greedyAlgorithmG(abstractData data)
	{
	...
	public int nextIteration() throws algorithmException
	{
		...
		ArrayList<Integer> lowHeurFront = myData.getLowestHeuristicFrontier();
		myData.addSolution(lowHeurFront);
		return 0;
	}
