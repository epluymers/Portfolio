//==============================================================================
/**
 * File Name:   iterativeDeepeningSearchG.java
 *
...
/*
 * Class: iterativeDeepeningSearchG
 * Package: algorithmData
 * Implements: algorithmInterface
 * Description: Implements Iterative Deepening Search for Graph Data
 */
public class iterativeDeepeningSearchG implements algorithmInterface
{
	/*
	 ...
	 */
	public iterativeDeepeningSearchG(abstractData data)
	{
		myData = (graphData)data;
		iterationsCount = 0;
		itDepth = 1;
		myData.setDepthLimit(itDepth);
	}
	...
	public int nextIteration() throws algorithmException
	{
		...
		if(myData.getFrontierSize() == 0 && itDepth > 100)
		{
			return -1;
		}
		if(runDepthLimitedSearch() == -1)
		{
			itDepth++;
			myData.resetSolution();
			myData.setDepthLimit(itDepth);
		}
		return 0;
	}
	...
	public int runDepthLimitedSearch()
	{
